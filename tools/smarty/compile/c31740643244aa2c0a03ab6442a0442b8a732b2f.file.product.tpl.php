<?php /* Smarty version Smarty-3.1.11, created on 2013-10-22 08:59:33
         compiled from "/home/w/webdeck/webdeck/public_html/themes/prestashop/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1859791947526606355645d7-56251564%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c31740643244aa2c0a03ab6442a0442b8a732b2f' => 
    array (
      0 => '/home/w/webdeck/webdeck/public_html/themes/prestashop/product.tpl',
      1 => 1382096618,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1859791947526606355645d7-56251564',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266063650e0a5_68449469',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266063650e0a5_68449469')) {function content_5266063650e0a5_68449469($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home/w/webdeck/webdeck/public_html/tools/smarty/plugins/modifier.escape.php';
if (!is_callable('smarty_modifier_date_format')) include '/home/w/webdeck/webdeck/public_html/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/w/webdeck/webdeck/public_html/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/home/w/webdeck/webdeck/public_html/tools/smarty/plugins/function.counter.php';
?>
...
<?php }else{ ?>0<?php }?>;
var reduction_price = <?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='amount'){?>(specific_currency ? <?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'];?>
 : <?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'];?>
 * currencyRate)<?php }else{ ?>0<?php }?>;
...
<?php }else{ ?>0<?php }?>;
var ipa_default = <?php if (isset($_smarty_tpl->tpl_vars['ipa_default']->value)){?><?php echo $_smarty_tpl->tpl_vars['ipa_default']->value;?>
<?php }else{ ?>0<?php }?>;
...
// Translations
var doesntExist = '<?php echo smartyTranslate(array('s'=>'The product does not exist in this model. Please choose another one','js'=>1),$_smarty_tpl);?>
';
...
';
var fieldRequired = '<?php echo smartyTranslate(array('s'=>'Please fill in all required fields, then save your customization.','js'=>1),$_smarty_tpl);?>
';
...
, <?php echo $_smarty_tpl->tpl_vars['combination']->value['minimal_quantity'];?>
	...
	<?php } ?>
	// Colors
	<?php if (count($_smarty_tpl->tpl_vars['colors']->value)>0){?>
		<?php if ($_smarty_tpl->tpl_vars['product']->value->id_color_default){?>var id_color_default = <?php echo intval($_smarty_tpl->tpl_vars['product']->value->id_color_default);?>
;<?php }?>
	<?php }?>
<?php }?>
//]]>
...
<div id="primary_block" class="clearfix">
	<h1><?php echo smarty_modifier_escape(smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value->name,65,'...'), 'htmlall', 'UTF-8');?>
</h1>
...
', 1)"/>
	...
	<div id="pb-right-column">
		<!-- product img-->
		<div id="image-block">
			<img src="<?php if ($_smarty_tpl->tpl_vars['have_image']->value){?><?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['cover']->value['id_image'],'large');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['img_prod_dir']->value;?>
<?php echo $_smarty_tpl->tpl_vars['lang_iso']->value;?>
-default-large.jpg<?php }?>"<?php if ($_smarty_tpl->tpl_vars['jqZoomEnabled']->value&&$_smarty_tpl->tpl_vars['have_image']->value){?> class="jqzoom"<?php }?> alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cover']->value['legend'], 'htmlall', 'UTF-8');?>
" title="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['cover']->value['legend'], 'htmlall', 'UTF-8');?>
...
">
						<a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'thickbox');?>
" rel="other-views" class="thickbox <?php if ((isset($_smarty_tpl->tpl_vars['image']->value['cover'])&&$_smarty_tpl->tpl_vars['image']->value['cover']==1)||(!isset($_smarty_tpl->tpl_vars['image']->value['cover'])&&$_smarty_tpl->getVariable('smarty')->value['foreach']['thumbnails']['first'])){?>shown<?php }?>" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image']->value['legend']);?>
">
							<img id="thumb_<?php echo $_smarty_tpl->tpl_vars['image']->value['id_image'];?>
" src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value->link_rewrite,$_smarty_tpl->tpl_vars['imageIds']->value,'medium');?>
...
" href="javascript:{}"><?php echo smartyTranslate(array('s'=>'Next'),$_smarty_tpl);?>
		...
		<?php }?>
		<?php if (isset($_smarty_tpl->tpl_vars['images']->value)&&count($_smarty_tpl->tpl_vars['images']->value)>1){?><p class="align_center clear"><span id="wrapResetImages" style="display: none;"><img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/cancel_16x18.gif" alt="<?php echo smartyTranslate(array('s'=>'Cancel'),$_smarty_tpl);?>
" width="16" height="18"/> <a id="resetImages" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['product']->value);?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['packItem']->value['name'], 'htmlall', 'UTF-8');?>
		...
		<?php if (isset($_smarty_tpl->tpl_vars['colors']->value)&&$_smarty_tpl->tpl_vars['colors']->value){?>
		<!-- colors -->
		<div id="color_picker">
...
" width="20" height="20" /><?php }?></a></li>
		...
		<!-- add to cart form-->
		<form id="buy_block" <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&!isset($_smarty_tpl->tpl_vars['groups']->value)&&$_smarty_tpl->tpl_vars['product']->value->quantity>0){?>class="hidden"<?php }?> action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart.php',true);?>
" method="post">
...
" class="on_sale_img"/>
					...
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2){?>
						<span id="our_price_display"><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['productPrice']->value),$_smarty_tpl);?>
</span>
...
<?php }?>
					...
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==2){?>
						<br />
						<span id="pretaxe_price"><span id="pretaxe_price_display"><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value->getPrice(false,@NULL,2)),$_smarty_tpl);?>
				...
				<?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']){?>
					...
					<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2){?>
						<?php if ($_smarty_tpl->tpl_vars['productPriceWithoutRedution']->value>$_smarty_tpl->tpl_vars['productPrice']->value){?>
							<span id="old_price_display"><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['productPriceWithoutRedution']->value),$_smarty_tpl);?>
</span>
...
<?php }?>
				...
				<?php }?>
				<?php if ($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction_type']=='percentage'){?>
					<p id="reduction_percent"><?php echo smartyTranslate(array('s'=>'(price reduced by'),$_smarty_tpl);?>
 <span id="reduction_percent_display"><?php echo $_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']*100;?>
</span> %<?php echo smartyTranslate(array('s'=>')'),$_smarty_tpl);?>
</p>
				<?php }?>
				<?php if (count($_smarty_tpl->tpl_vars['packItems']->value)){?>
					<p class="pack_price"><?php echo smartyTranslate(array('s'=>'instead of'),$_smarty_tpl);?>
 <span style="text-decoration: line-through;"><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['product']->value->getNoPackPrice()),$_smarty_tpl);?>
</span></p>
					<br class="clear" />
				<?php }?>
 ...
 <span id="ecotax_price_display"><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==2){?><?php echo Product::convertAndFormatPrice($_smarty_tpl->tpl_vars['ecotax_tax_exc']->value);?>
<?php }else{ ?><?php echo Product::convertAndFormatPrice($_smarty_tpl->tpl_vars['ecotax_tax_inc']->value);?>
<?php }?></span> <?php echo smartyTranslate(array('s'=>'for green tax'),$_smarty_tpl);?>
				...
				<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->unity)&&$_smarty_tpl->tpl_vars['product']->value->unit_price_ratio>0.000000){?>
					...
					<p class="unit-price"><span id="unit_price_display"><?php echo Product::convertPrice(array('price'=>$_smarty_tpl->tpl_vars['unit_price']->value),$_smarty_tpl);?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['group_attribute']->value, 'htmlall', 'UTF-8');?>
			...
			<p id="product_reference" <?php if (isset($_smarty_tpl->tpl_vars['groups']->value)||!$_smarty_tpl->tpl_vars['product']->value->reference){?>style="display: none;"<?php }?>><label for="product_reference"><?php echo smartyTranslate(array('s'=>'Reference :'),$_smarty_tpl);?>
 </label><span class="editable"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->reference, 'htmlall', 'UTF-8');?>
</span></p>
...
<?php }else{ ?>1<?php }?><?php }?>" size="2" <?php if ($_smarty_tpl->tpl_vars['product']->value->minimal_quantity>1){?>onkeyup="checkMinimalQuantity(<?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
);"<?php }?> />
			</p>

			<!-- minimal quantity wanted -->
			<p id="minimal_quantity_wanted_p"<?php if ($_smarty_tpl->tpl_vars['product']->value->minimal_quantity<=1||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?> style="display: none;"<?php }?>><?php echo smartyTranslate(array('s'=>'You must add '),$_smarty_tpl);?>
...
<?php }?>
		...
		<?php }?>
		<?php if ($_smarty_tpl->tpl_vars['HOOK_EXTRA_RIGHT']->value){?><?php echo $_smarty_tpl->tpl_vars['HOOK_EXTRA_RIGHT']->value;?>
<?php }?>
	</div>
</div>

<?php if ($_smarty_tpl->tpl_vars['quantity_discounts']->value){?>
<!-- quantity discount -->
<ul class="idTabs">
	<li><a style="cursor: pointer" class="selected"><?php echo smartyTranslate(array('s'=>'Sliding scale pricing'),$_smarty_tpl);?>
</a></li>
</ul>
...
<?php if ($_smarty_tpl->tpl_vars['product']->value->description||$_smarty_tpl->tpl_vars['features']->value||$_smarty_tpl->tpl_vars['accessories']->value||$_smarty_tpl->tpl_vars['HOOK_PRODUCT_TAB']->value||$_smarty_tpl->tpl_vars['attachments']->value){?>
...
?>
			<li><a href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('attachment.php',true);?>
...
?>
						...
						<li class="ajax_block_product <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['first']){?>first_item<?php }elseif($_smarty_tpl->getVariable('smarty')->value['foreach']['accessories_list']['last']){?>last_item<?php }else{ ?>item<?php }?> product_accessories_description">
							<h5><a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['accessoryLink']->value, 'htmlall', 'UTF-8');?>
...
" class="product_image"><img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['accessory']->value['link_rewrite'],$_smarty_tpl->tpl_vars['accessory']->value['id_image'],'medium');?>
...
" class="product_description"><?php echo smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['accessory']->value['description_short']),70,'...');?>
</a>
							</div>
							<p class="product_accessories_price">
								<?php if ($_smarty_tpl->tpl_vars['accessory']->value['show_price']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><span class="price"><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value!=1){?><?php echo Product::displayWtPrice(array('p'=>$_smarty_tpl->tpl_vars['accessory']->value['price']),$_smarty_tpl);?>
<?php }else{ ?><?php echo Product::displayWtPrice(array('p'=>$_smarty_tpl->tpl_vars['accessory']->value['price_tax_exc']),$_smarty_tpl);?>
<?php }?></span><?php }?>
...
"><?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
								...
								<?php if (($_smarty_tpl->tpl_vars['accessory']->value['id_product_attribute']==0||(isset($_smarty_tpl->tpl_vars['add_prod_display']->value)&&($_smarty_tpl->tpl_vars['add_prod_display']->value==1)))&&($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
									<a class="exclusive button ajax_add_to_cart_button" href="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart.php',true);?>
...
&amp;add" rel="nofollow ajax_id_product_<?php echo intval($_smarty_tpl->tpl_vars['accessory']->value['id_product']);?>
...
<?php if ($_smarty_tpl->tpl_vars['product']->value->customizable){?>
	<p>
		<img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['field']->value['type']==0){?>
						<li class="customizationUploadLine<?php if ($_smarty_tpl->tpl_vars['field']->value['required']){?> required<?php }?>"><?php $_smarty_tpl->tpl_vars['key'] = new Smarty_variable(((('pictures_').($_smarty_tpl->tpl_vars['product']->value->id)).('_')).($_smarty_tpl->tpl_vars['field']->value['id_customization_field']), null, 0);?>
							<?php if (isset($_smarty_tpl->tpl_vars['pictures']->value[$_smarty_tpl->tpl_vars['key']->value])){?><div class="customizationUploadBrowse">
...
" class="customization_block_input <?php if (isset($_smarty_tpl->tpl_vars['pictures']->value[$_smarty_tpl->tpl_vars['key']->value])){?>filled<?php }?>" /><?php if ($_smarty_tpl->tpl_vars['field']->value['required']){?><sup>*</sup><?php }?>
...
?>
					<?php if ($_smarty_tpl->tpl_vars['field']->value['type']==1){?>
						<li class="customizationUploadLine<?php if ($_smarty_tpl->tpl_vars['field']->value['required']){?> required<?php }?>"><?php $_smarty_tpl->tpl_vars['key'] = new Smarty_variable(((('textFields_').($_smarty_tpl->tpl_vars['product']->value->id)).('_')).($_smarty_tpl->tpl_vars['field']->value['id_customization_field']), null, 0);?>
							<?php if (!empty($_smarty_tpl->tpl_vars['field']->value['name'])){?><?php echo $_smarty_tpl->tpl_vars['field']->value['name'];?>
<?php }?><?php if ($_smarty_tpl->tpl_vars['field']->value['required']){?><sup>*</sup><?php }?><textarea name="textField<?php echo $_smarty_tpl->tpl_vars['field']->value['id_customization_field'];?>
...
<?php }?></textarea>
			...
			<p style="clear: left;" id="customizedDatas">
				<input type="hidden" name="ipa_customization" id="ipa_customization" value="<?php echo $_smarty_tpl->tpl_vars['ipa_customization']->value;?>
" />
